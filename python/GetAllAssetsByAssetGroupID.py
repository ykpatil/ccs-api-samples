#Script to retrieve the details of all the assets that belong to specific asset group by  providing assetgroup GUID in the input request.
...
#GetAllAssetsByAssetGroupID API endpoint URL. Provide the Assetgroup GUID in the request for retrieving the details of all the assets in the specific asset group.
#You can use SerachAssetGroup API to get the GUID of the Asset group.
url = "https://" + HostName + ":" + PortNumber + "/ccs/api/v1/AssetGroup/817fd810-83e1-4a29-85ea-8aa6204421e3/Assets"
