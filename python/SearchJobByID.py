#Script to search job details by providing job GUID in the request.
...
#Search Job by ID API endpoint URL. Provide the job GUID in the request for searching job details for specific job.
url = "https://" + HostName + ":" + PortNumber + "/ccs/api/v1/Jobs/a282d163-2248-4904-8135-0eaf08be8e55"
