# Script to search remediation ticket details based on ticket ID
...
# Remediation ticket details URI
url = "https://" + HostName + ":" + PortNumber + "/ccs/api/v1/RemediationTickets"

# provide the ticket ID in the query string like-INCA0000001

querystring = {"TicketNumber":"INCA0000001"}
